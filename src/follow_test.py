...
class FollowerRobot:
    def __init__(self):
        ...
        # parametry pida sa dobrane bardzo na oko 
        self.kp_linear = 1.0
        self.ki_linear = 0.0
        self.kd_linear = 0.05
        ...
        # parametry pida sa niedobrane 
        # pokazuje bardzo pdobne yaw robota i tagu a w rzeczywistosci robot jest zauwazalnie mniej obro
    ...
    def compute_control_command(self):
        ...
        _, _, leader_yaw = euler_from_quaternion(orientation_list)
        ...
        orientation_error = leader_yaw - self.follower_yaw
